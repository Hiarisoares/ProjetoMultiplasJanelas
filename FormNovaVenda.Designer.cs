namespace AplicativoComMultiplasJanelas
{
	partial class FormNovaVenda
	{
		...
		private void InitializeComponent()
		{
			...
			textBoxTotalComDesconto.TabIndex = 38;
			// 
			// textBoxValorTotal
			// 
			...
			textBoxPrecoUnitario.TabIndex = 36;
			// 
			// comboBoxCliente
			// 
			...
			numericUpDownDesconto.TabIndex = 29;
			...
			numericUpDownQuantidade.TabIndex = 27;
